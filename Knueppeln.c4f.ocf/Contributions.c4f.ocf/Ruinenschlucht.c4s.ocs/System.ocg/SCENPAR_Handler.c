...
global func CheckScenarioParameters()
{
	...
	if(SCENPAR_DayNight == 1)
	{
		daytime_scenpar = 32400;
	}
	if(SCENPAR_DayNight == 2)
	{
		daytime_scenpar = 1440;
	}
	if(SCENPAR_DayNight == 3)
	{
		daytime_scenpar = [32400,1440][Random(2)];
	}
}

global func WinKillCount()
{
